...
public class Prescription {
    ...
    @Size(min = 3, max = 100, message = "patientName length is between 3 and 100 characters")
    ...
    @Size(min = 3, max = 100, message = "medication length is between 3 and 100 characters")
    ...
    @Size(max = 200, message = "doctorNotes length is not exceed 200 characters")
