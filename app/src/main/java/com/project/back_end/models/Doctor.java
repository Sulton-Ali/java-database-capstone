...
public class Doctor {
    ...
    @Size(min = 3, max = 100, message = "name length is between 3 and 100 characters")
    private String name;
    ...
    @Size(min = 3, max = 50, message = "specialty length is 3 and 50 characters")
    ...
    @Email(message = "email should be correct email")
    ...
    @Size(min = 6, message = "password length is mon 6 characters")
    ...
    @Pattern(regexp = "^[0-9]{12}$", message = "phone number must be 12 digits")
