...
public class Patient {
    ...
    @Size(min = 6, message = "password length must be least 6 characters long")
    ...
    @Pattern(regexp = "^[0-9]{12}$", message = "phone length must be 12 digits")
    ...
    @Size(max = 255, message = "address does not exceed 255 characters")
